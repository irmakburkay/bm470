            ...
            $(".delete-click").click(function (event) {
                ...
                if (confirm("Blogu silmek istediğinize emin misiniz?") == true) {
                    $.post("/bm470/blog/delete", {"blogID": blogID}, function (data, status) {
                        alert("Status: " + status);
                        window.location = "/bm470/user/" + ${user.userID}
                    })
                }
            })
        })
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="row justify-content-end">
                                ...
                                <div class="col-auto">
                                    <c:choose>
                                        <c:when test="${blogItem.isActive==true}">
                                        ...
                                        <c:otherwise>
                                            <button type="button" class="btn btn-success approve-click" data-href="${blogItem.blogID}">
